    ...
    <div id="borrowed">
        <div class="details">
            ...
            <div class="books">
                ...
                $borrowed = "";
                $return = "";
                //accepted books table
                $acceptsql = "select * from acceptedbooks where userId=$userId";
                $accpetres = mysqli_query($conn, $acceptsql);
                $acceptCount = $accpetres->num_rows;
                if ($acceptCount == 0) {
                    echo '<div style="text-align:center;">No Borrowed books</div>';
                } else {

                    while ($acceptItem = mysqli_fetch_assoc($accpetres)) {
                        $requestId = $acceptItem['requestId'];
                        $borrowDate = $acceptItem['borrowDate'];
                        $returnDate = $acceptItem['returnDate'];
                            ...
                            echo
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="brw-rt">
                                            <div class="brw">Borrow Date:&nbsp; <b>' . $borrowDate . '</b> </div>
